...
const validateMeta = (doc, userid) => {
  // if there is no meta_access specified,
  // make current user owner, give r,w access
...
const extractParticipants = (doc) => {
  if(!doc.meta_access) return [];
  return Object.keys(doc.meta_access);
}
